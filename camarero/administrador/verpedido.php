                    ...
                    try {
                        ...
                        if (!empty ($result)) {
                            ...
                            <div class="col-md-12 text-center">
                                ...
                                <div class="mt-4">
                                    <a class="btn btn-danger btn-block btn-flat eliminarPedido"
                                        href="pedido/eliminarpedido.php?id_pedido=<?php echo $id_pedido; ?>&id_sala=<?php echo $_GET['id_sala']; ?>&mesa=<?php echo $_GET['mesa']; ?>">
