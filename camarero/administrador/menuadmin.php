                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        if ($_SESSION['rol'] == 'administrador' || $_SESSION['rol'] == 'cocinero' || $_SESSION['rol'] == 'camarero') {
                                            echo '<li><a class="dropdown-item" href="../administrador/historialventa.php">Estado de pedido</a></li>';
                                        }
                                        ?>
                                    </ul>
                                </li>
                                ...
                                if ($_SESSION['rol'] == 'administrador') {
                                    echo '<li class="nav-item dropdown">
                                            ...
                                            <ul class="dropdown-menu">
                                                ...
                                                <li><a class="dropdown-item" href="usuarios.php">Regristrar asistencia</a></li>
                                            </ul>
                                          </li>';
                                }
                                ?>
