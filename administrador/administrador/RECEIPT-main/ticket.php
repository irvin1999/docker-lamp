...
$query = "SELECT
            ...
            u.nombre AS usuario_nombre,  -- Nombre del cajero
            d.cantidad,
          ...
          JOIN
            platos pl ON d.nombre = pl.nombre  -- Ajustar según tu diseño
          JOIN
...
foreach ($productos as $producto) {
    ...
    $pdf->Cell(15, 4, iconv("UTF-8", "ISO-8859-1", "$0.00 USD"), 0, 0, 'C');
