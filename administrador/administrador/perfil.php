                ...
                <div class="card-body">
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="dni" class="form-control" name="dni" value="<?php echo $usuario['dni']; ?>" pattern="[XYZxyz]?\d{7}[TRWAGMYFPDXBNJZSQVHLCKEtrwagmyfpdxbnjzsqvhlcke]|[a-zA-Z]?\d{8}[a-zA-Z]" title="Por favor, introduce un DNI o NIE válido." required maxlength="9">
