...
<body class="sub_page">
    ...
    <div class="container-fluid">
        <div class="row">
            <form action="platos/crearPlato.php" method="post" enctype="multipart/form-data"
                class="col-md-4 p-5 form-container">
                <h1 class="text-center p-3">Agregar Plato</h1>
                ...
                <div class="form-group">
                    ...
                    <select id="categoria" class="form-control" aria-label="Default select example" name="categoria" required>
                        <?php
