...
<body class="sub_page">
  ...
  <div class="container-fluid row">
    <form action="../php/crearUser.php" method="post" enctype="multipart/form-data" class="col-md-4 p-5 form-container">
      ...
      <div class="form-group">
        ...
        <input type="text" id="dni" class="form-control" name="dni"
          pattern="[XYZxyz]?\d{7}[TRWAGMYFPDXBNJZSQVHLCKEtrwagmyfpdxbnjzsqvhlcke]|[a-zA-Z]?\d{8}[a-zA-Z]"
          title="Por favor, introduce un DNI o NIE válido." required maxlength="10">
